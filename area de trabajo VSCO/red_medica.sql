...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-12-2021 a las 03:10:50
...
(1, 7, 'Propiedades del tomate cultivado en las marismas de Lebrija', 'Antonio Vasquez Perez', 'https://www.youtube.com/watch?v=5qap5aO4i9A', 'documento-pdf/14editorialcovid-19pdf.pdf', 3, 1, '2021-12-10 20:39:00', '2021-12-10 20:40:00', 'Terminada', 3, 'A'),
(2, 7, 'Enfoque Mï¿½dico de un Paciente con Diabetes y COVID-19', 'Abraham Perez,Armando Vasquez,Germï¿½n Gomez,Hï¿½ctor Acosta', 'https://www.youtube.com/watch?v=5qap5aO4i9A', 'documentos/documeto.pdf', 3, 2, '2021-12-10 19:22:30', '2021-12-10 19:23:30', 'Terminada', 5, 'A'),
(3, 7, 'titulo', 'participantes\r\nsegudon participante', 'https://www.youtube.com/watch?v=tyMpXRRfdow', 'documento-confe-pdf/hoja-de-pasantia-isc-nuevapdf.pdf', 12, 2, '2021-12-10 20:43:00', '2021-12-10 20:44:00', 'Programada', 28, 'A'),
(4, 7, 'Promblema para dormir ', 'Luis Enrique\r\nMaria Capellan\r\nLuis Benua', 'https://www.youtube.com/watch?v=E5hXO6Mff6Q', 'documento-confe-pdf/luis-enriquegomez-garcia-ccnarsm122020-angel-maria-villar-galanpdf.pdf', NULL, 2, '2021-12-10 19:16:00', '2021-12-10 19:17:00', 'Terminada', NULL, 'A');
...
(1, 'Luis Enrique', 'Gomez', 'luis55', 'ADFdD455', 2, 'La Vega', 2, '827ccb0eea8a706c4c34a16891f84e7b', 'A'),
...
(13, 'Juan Rodrigue', 'Vasquez', 'juan67', 'adfa234', 1, NULL, 2, '827ccb0eea8a706c4c34a16891f84e7b', 'A'),
(14, 'Luisa', 'Perez', 'luisa20', 'fadsd234', 1, 'La Vega', 2, '827ccb0eea8a706c4c34a16891f84e7b', 'A');
...
(1, 1, 'Guía de Limpieza y Desinfección de  Superficies Hospitalarias', 'Dr. Rafael Sánchez Cárdenas\r\nMinistro de Salud Pública \r\nDr. Francisco Neftalí Vásquez \r\nViceministro de Garantía de la Calidad\r\nDr. Héctor Quezada\r\nViceministro de Salud Colectiva', 'Uno de los principales desafíos que enfrenta el Sistema Nacional de Salud es lograr que \r\nlos establecimientos de salud sean lugares seguros para los pacientes y sus familiares, así \r\ncomo para el personal que en ellos labora. En relación con los riesgos biológicos, reducirlos \r\nrequiere fortalecer las medidas de bioseguridad como estrategia efectiva de contención de \r\nla transmisión de patógenos y de prevención de las Infecciones Asociadas a la Atención en \r\nSalud (IAAS).\r\nSi bien los pacientes constituyen el principal reservorio de microorganismos causantes de \r\nIAAS, algunos pueden ser transmitidos a través del ambiente, sobre todo de las superficies \r\ny de los equipos de las áreas dedicadas a la atención, las cuales actúan como fuente de \r\ninfección al entrar en contacto con secreciones y fluidos provenientes de los pacientes. \r\nExiste asociación entre la adecuada higienización de las superficies contaminadas, mediante \r\nlimpieza y desinfección, y la reducción del riesgo de trasmisión cruzada y de brotes de IAAS \r\nocasionados por ciertos agentes infecciosos. Además, la limpieza y la desinfección mejoran \r\nel aspecto estético de los establecimientos de salud y contribuyen a aumentar la confianza \r\ny el confort de los pacientes.', 'Ministerio de Salud Pública Santo Domingo, República Dominicana, 2020', '', '', '', 'documento-pdf/guia-limpiezapdf.pdf', '2021-10-26', 1, 'pdf', 10, 'A'),
(2, 3, 'ï¿½mbito de actuaciï¿½n de la cardiologï¿½a en los nuevos escenarios clï¿½nicos', 'Javier Escaned Barbosa, Eulalia Roig Minguell, Francisco J. Chorro Gascï¿½, Eduardo De Teresa Galvï¿½n,Manuel Jimï¿½nez Mena, Esteban Lï¿½pez de Sï¿½ y Areses, Fernando Alfonso Man', 'A cardiologï¿½a es la disciplina o especialidad mï¿½dica encargada de la prevenciï¿½n, el diagnï¿½stico y el tratamiento de las enfermedades cardiovasculares. Al\r\nconstituir la principal causa de morbimortalidad en Espaï¿½a y en la Uniï¿½n Europea1\r\n, los profesionales de la\r\ncardiologï¿½a tienen, respecto a otras especialidades mï¿½dicas, una responsabilidad y autoridad morales aï¿½adidas, derivadas de la relevancia que tiene para la sociedad un ejercicio excelente de la lucha contra la\r\nenfermedad cardiovascular. De ahï¿½ la importancia de\r\nefectuar un seguimiento de las rï¿½pidas transiciones\r\nque en el momento actual se estï¿½n dando en los ï¿½rdenes sociales, administrativos, educativos, asistenciales\r\ny profesionales, transiciones que necesariamente condicionarï¿½n nuevos contextos para el ejercicio de la cardiologï¿½a y para sus profesionales.', '1.	Murray JL, Lopez AD. Alternative projections of mortality anddisability by cause 1990-2020: Global Burden of Disease Study. Lancet. 1997;349:1498-504. 2.	Escaned J, Rydï¿½n L, Zamorano JL, Poole-Wilson P, Fuster V,Gitt A, et al. Tendencias y contextos en la prï¿½ctica de la cardiologï¿½a en los prï¿½ximos 15 aï¿½os. La Declaraciï¿½n de Madrid: un documento de la Conferencia Europea sobre el Futuro de la Cardiologï¿½a, Madrid, 2-3 de junio de 2006. Rev Esp Cardiol. 2007;60: 294-8. 3.	De Teresa-Galvï¿½n E, Alonso-Pulpï¿½n L, Barber P, Bover Freire R,Castro Beiras A, Cruz Fernï¿½ndez JM, et al. Desequilibrio entre la oferta y las necesidades de cardiï¿½logos en Espaï¿½a. ', '', '', '', 'documento-word/13116204docx.docx', '2021-10-26', 2, 'docx', 30, 'A'),
...
(5, 7, 'titulo', 'autor', 'Rusumen', 'fuente', '', '', '', 'documento-pdf/6401pdf.pdf', '2021-11-03', 2, 'pdf', 10, 'I'),
...
CREATE TABLE `recordatorio` (
  `id_recorda` int(20) NOT NULL,
  `id_medicorec` int(20) DEFAULT NULL,
  `id_confererec` int(20) DEFAULT NULL,
  `fechainiciorec` datetime DEFAULT NULL,
  `fechafinalrec` datetime DEFAULT NULL,
  `estado` varchar(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `recordatorio` (`id_recorda`, `id_medicorec`, `id_confererec`, `fechainiciorec`, `fechafinalrec`, `estado`) VALUES
(1, 7, 3, NULL, NULL, 'A'),
(2, 7, 2, NULL, NULL, 'A'),
(3, 7, 3, NULL, NULL, 'A'),
(4, 7, 3, NULL, NULL, 'A'),
...
ALTER TABLE `recordatorio`
  ADD PRIMARY KEY (`id_recorda`),
  ADD KEY `medico recordatorio` (`id_medicorec`);
...
--
ALTER TABLE `conferencia`
  MODIFY `id_confe` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `medico`
  MODIFY `id_medico` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `recordatorio`
  MODIFY `id_recorda` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
