...
<div  class="table-responsive">
        <table class="table">
                ...
                <?php while ($rowSql = mysqli_fetch_assoc($sql)){ 
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 
                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 
                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<h5 style="display: inline;"> Material:</h5> <?php echo $rowSql["material_confe"]; ?></td>
                        
                        
                        <td style="text-align: center; font-size: 49px;"><?php echo("<a class='btn btn-info' style='text-align: center; font-size: 19px;' href='memoriac.php?id=".$rowSql["id_confe"]."'  role='button'><i class='fa fa-youtube-play' aria-hidden='true'></i></a>");?></td>
                        </tr>
