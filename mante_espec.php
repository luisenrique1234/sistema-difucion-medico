    ...
    <header id="header">
        ...
        <div>
            <div class="panel-heading">
                <h1> Listado de Especialidades medicas</h1>
            ...
            <td>
            <a href='actualizarm_medico.php?id=" . $row["id_espec"] . "' class='btn btn-info' style='background-color: #0d87ac;'>Editar</a>
            
            <a href='php/tablas_mantenimiento.php?accion=DLT&id=" . $row["id_espec"] . "' class='btn btn-danger confirm'>Eliminar</a>
            </td>
            </tr>
