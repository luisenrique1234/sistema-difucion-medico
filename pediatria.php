                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="active" class="dropdown"><a href="#">Pediatria<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    <li><a href="#">Enbarosos</a></li>
                                    <li><a href="#">Maltrato infantil</a></li>
                                    <li><a href="#">Salud infantil</a></li>
                                </ul>
                            </li>
                            <li class="dropdown"><a href="Cardiologia.php">Cardiologia<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    <li><a href="#">Ataques al corazon</a></li>
                                    <li><a href="#">Arritmia cardiaca</a></li>
                                    <li><a href="#">Taquicardia</a></li>
                                </ul>
                            </li>
