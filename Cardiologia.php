        ...
        <div class="container">
            <div class="row">
                ...
                <?php
                    ...
                    AND inv_cientifica.cotegoria_inv='Cardiología' ORDER BY fecha DESC";
                    ...
                    medico.nombre_medico,medico.apellido_medico FROM publicacion,medico WHERE publicacion.id_medico_pu=medico.id_medico AND publicacion.categoria_public='Cardiología'  ORDER BY publicacion.me_gusta_pu DESC";
