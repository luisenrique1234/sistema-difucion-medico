                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="active" class="dropdown"><a href="#">Cardiologia<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
        ...
        <div class="container">
            <div class="row">
                ...
                <?php
                    ...
                    AND inv_cientifica.cotegoria_inv='2' AND inv_cientifica.cotegoria_inv=especialidad.id_espec ORDER BY me_gusta_inv DESC";
                    ...
                    medico.nombre_medico,medico.apellido_medico,especialidad.espec_descripsion FROM publicacion,medico,especialidad WHERE publicacion.id_medico_pu=medico.id_medico AND publicacion.categoria_public='2' AND publicacion.categoria_public=especialidad.id_espec ORDER BY publicacion.me_gusta_pu DESC";
