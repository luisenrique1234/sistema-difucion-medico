        ...
        <div class="container">
            <div class="row">
                ...
                <?php
                    ...
                    inv_cientifica.cotegoria_inv,medico.nombre_medico,medico.apellido_medico FROM inv_cientifica,medico WHERE inv_cientifica.id_medico_inv=medico.id_medico AND inv_cientifica.cotegoria_inv='$espesicialidad' AND inv_cientifica.estado='A' ORDER BY fecha DESC";
                    ...
                    medico.nombre_medico,medico.apellido_medico FROM publicacion,medico WHERE publicacion.id_medico_pu=medico.id_medico AND publicacion.categoria_public='$espesicialidad' AND publicacion.estado='A' ORDER BY publicacion.me_gusta_pu DESC";
