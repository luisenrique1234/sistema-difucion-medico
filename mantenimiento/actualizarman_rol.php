                                ...
                                <div>
                                    <form action="../php/tablas_mantenimiento.php?accion=UDTROL" method="POST" enctype="multipart/form-data">
                                        <div>
                                            ...
                                            <input  type="text" 
                                            name="codigorol" require=""  class="form-control" readonly="" value="<?php echo $row['id_roles']?>">
                                            </div>
				                            </div>
                                                <div class="col-md-4 col-md-offset-0 col-sm-4 col-sm-offset-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"  required="required" name="roles"
                                                            placeholder="Titulo" class="form-control" value="<?php echo $row['descripcion']?>">
                                                    </div>
                                                </div>
