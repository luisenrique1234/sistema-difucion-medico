        ...
        <div style="width: 50%;">
                    <div id="formc" class="post-thumb">
                            <div class="panel-dafault" style="margin-top: 12px">
                                <!--panel de crear -->
                                <div>
                                    <form action="../php/tablas_mantenimiento.php?accion=INSESPC" method="POST" enctype="multipart/form-data">
                                        <div>
                                            <div>
                                                <div style="margin-bottom: 2rem;" class="text-center col-lg-10 col-lg-offset-1 col-xs-12 col-xs-offset-0">
                                               <h1 class="title">Nuevo Especialidad</h1>
                                                </div>
                                                <div class="col-md-4 col-md-offset-4 col-sm-4 col-sm-offset-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"  required="required" name="especia"
                                                            placeholder="Especialidad del médico" class="form-control">
                                                    </div>
                                                </div>
                ...
                <div class="col-sm-12 ">
                    <div class="col-sm-12">
                        <div class=" copyright-text text-center ">
                            <p>Sistema de difusión de información méica 2022. Todos los derechos reservados.</p>
