            ...
            <div style="width: 50%;">
                <div id="formc" class="post-thumb">
                    <div class="panel-dafault" style="margin-top: 12px">
                        <!--panel de crear -->
                        <div>
                            <form action="../php/reg_admin.php?accion=UDT2" method="POST" enctype="multipart/form-data">
                                <div>
                                    <div>
                                        ...
                                        <input type="hidden" name="codigoadm" require="" class="form-control" readonly="" value="<?php echo $row['id_admin'] ?>">

                                        <div class="col-md-4 col-md-offset-2">
                                            <div class="form-group">
                                                <label class="control-label"><i class="fa fa-id-badge"></i> Nombre</label>
                                                <input type="text" name="nombread" require="" class="form-control" value="<?php echo $row['adminis'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-md-offset-0">
                                            <div class="form-group">
                                                <label class="control-label"><i class="fa fa-id-card-o"></i> Rol del administrador<span style="color: red">*</span></label>
                                                <select name="roladmin" class="form-control" required="required">
                                                    <?php
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $id2 ?>" <?php if ($row['idRolA'] == $id2) {
                                                                                                echo "selected";
                                        ...
                                        <div class="col-md-4 col-md-offset-2">
                                            <div class="form-group">
                                                <label class="control-label"><i class="fa fa-unlock-alt"></i> Contraseña<span style="color: red">*</span></label>
                                                <input type="password" required="required" id="password" name="pass" value="<?php echo  base64_decode($row['pass']); ?>" class="form-control">
                                            </div>
                                        ...
                                        <div style="display: flex; flex-direction:row; width: 100%; justify-content: center; padding-top: 2rem; padding-bottom: 2rem;">
                                            <div style="margin-right: 30px;">
                                                <a href="mante_admin.php" class="btn btn-danger btn-lg ">Cancelar</a>
                                            </div>
                                            <div>
