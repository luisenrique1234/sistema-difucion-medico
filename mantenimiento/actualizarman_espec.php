...
<head>
    ...
    <title>Actulizar Especialidad</title>
                                    ...
                                    <form action="../php/tablas_mantenimiento.php?accion=UDTEPC" method="POST" enctype="multipart/form-data">
                                        <div>
                                            <div>
                                               ...
                                               <h1 class="title">Editar Especialidad</h1>
                                                </div>
                                                
                                                <div class="col-md-3 col-md-offset-3 col-sm-4 col-sm-offset-2">
                                            <div class="form-group">
                                                <label class="control-label"><i class="fa fa-id-badge"></i> ID</label>
                                            <input  type="text" 
                                            name="codigoespc" require=""  class="form-control" readonly="" value="<?php echo $row['id_espec']?>">
                                            </div>
				                            </div>
                                                <div class="col-md-4 col-md-offset-0 col-sm-4 col-sm-offset-2">
                                                    <div class="form-group">
                                                        <label class="control-label"><i class="fa fa-user-md"></i> Especialidad<span
                                                                style="color: red">*</span></label>
                                                        <input type="text"  required="required" name="especialidad"
                                                            placeholder="Titulo" class="form-control" value="<?php echo $row['espec_descripsion']?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div style="margin-right: 30px;">
                                                    <a href="mante_espec.php" class="btn btn-danger btn-lg ">Cancelar</a>
                                                    </div>
                                                    <div>
