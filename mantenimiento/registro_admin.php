            ...
            <div style="width: 50%;">
                <div id="formc" class="post-thumb">
                    <div class="panel-dafault" style="margin-top: 12px">
                        <!--panel de crear -->
                        <div>
                            <form action="../php/reg_admin.php?accion=INS" method="POST" enctype="multipart/form-data">
                                <div>
                                    <div>
                                        ...
                                        <div class="col-md-4 col-md-offset-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nombread" required="" class="form-control" placeholder="Nombre">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-md-offset-2">
                                            <div class="form-group">
                                                ...
                                                <input type="password" required="required" id="password" name="pass" placeholder="Contraseña" class="form-control">
                                            </div>
