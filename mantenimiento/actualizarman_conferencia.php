        ...
        <div style="width: 50%;">
                    <div id="formc" class="post-thumb">
                            <div class="panel-dafault" style="margin-top: 12px">
                                <!--panel de crear -->
                                <div>
                                    <form action="../php/tablas_mantenimiento.php?accion=UDTCON" method="POST" enctype="multipart/form-data">
                                        <div>
                                            <div>
                                            ...
                                            name="codiconfe" require=""  class="form-control" readonly="" value="<?php echo $row['id_confe']?>">
                                                ...
                                                <div style="margin-right: 30px;">
                                                    <a href="mante_confe.php" class="btn btn-danger btn-lg ">Cancelar</a>
                                                    </div>
                                                    <div>
