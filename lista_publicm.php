...
<body class="dark">
    <header id="header">
        ...
        <div>
            ...
            <td>
            <a href='actualizar_public.php?id=" . $row["id_public"] . "' class='btn btn-info' style='background-color: #0d87ac;'>Editar</a>
            <br>
            <br>
        ...
        <div>
            ...
            <td>
            <a href='actualizar_invest.php?id=" . $row["id_inv"] . "' class='btn btn-info' style='background-color: #0d87ac;'>Editar</a>
            <br>
            <br>
